...
use Chatify\Http\Controllers\Api\CustomJsonResponse;
...
class MessagesController extends Controller
{
    ...
    {
        // Get the authenticated user from Laravel's Auth::user() method
        $laravelUser = Auth::user();

        // Check if the user is authenticated
        if ($laravelUser) {
            // Convert the Laravel user to Chatify\User
            $chatifyUser = User::find($laravelUser->id);

            // Call pusherAuth() method with Chatify\User object
     ...
     */
    public function send(Request $request) : CustomJsonResponse
    {
        // default variables
        $error = (object)[
            'status' => 0,
    ...
    public function seen(Request $request)
    {
        ...
        // send the response
        return response()->json([
            'status' => true, // Atau sesuaikan dengan logika bisnis Anda
        ], 200);
    }
